...
const getFormJsonFromApi = async (message: any) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    const formGetUrl = `https://www.formstack.com/api/v2/form/${formId}/notification.json`;
...
class ApiNotificationEmailCacheManager {
  static #instance: ApiNotificationEmailCacheManager;
  #cacheDirectory = process.cwd() + '/api-cache/notification-email';
  ...
  static getInstance(): ApiNotificationEmailCacheManager {
    if (!ApiNotificationEmailCacheManager.#instance) {
      ApiNotificationEmailCacheManager.#instance =
        new ApiNotificationEmailCacheManager();
    }
    return ApiNotificationEmailCacheManager.#instance;
  }
}

export { ApiNotificationEmailCacheManager };
